...
config.compilerWasm = {
    getRuntime: async ()=>await (()=>{
            const e = new Error("Cannot find module '@prisma/client/runtime/query_compiler_bg.postgresql.mjs'");
            e.code = 'MODULE_NOT_FOUND';
            throw e;
        })(),
    getQueryCompilerWasmModule: async ()=>{
        const { wasm } = await (()=>{
            const e = new Error("Cannot find module '@prisma/client/runtime/query_compiler_bg.postgresql.wasm-base64.mjs'");
            e.code = 'MODULE_NOT_FOUND';
            throw e;
        })();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3fcc2179._.js.map